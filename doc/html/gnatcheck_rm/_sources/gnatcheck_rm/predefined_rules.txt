...
.. index:: Positional_Actuals_For_Defaulted_Parameters rule
...
.. index:: Recursive_Subprograms rule
...
.. index:: Unconditional_Exits rule
...
*
  For the ``+R`` option:
  unless the parameter is ``Default``, then only the explicitly specified
