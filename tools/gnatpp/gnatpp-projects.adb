...
with Ada_Trees.Formatting.Dictionaries; use Ada_Trees.Formatting.Dictionaries;
   ...
   begin
      ...
      loop
         ...
         Common_Arg := Scan_Common_Arg
           (My_Project, First_Pass, Parser, In_Switches,
            ...
            when 'D' =>
               ...
               if not First_Pass then
                  if Full_Switch (Parser => Parser) = "D-" then
                     ...
                     Use_Dictionary := True;
                     Ada_Trees.Formatting.Dictionaries.
            ...
            when 'g' | '-' =>
               ...
               if not First_Pass then
                  if Full_Switch (Parser => Parser) = "-RTS" then
                     Store_Option ("--RTS=" & Parameter (Parser => Parser));
