...
--                                 B o d y                                  --
--                                                                          --
--                   Copyright (C) 2013-2014, AdaCore, Inc.                 --
--                                                                          --
...
package body Ada_Trees.Buffers is
...
--      end if;
   ...
   is
      ...
      package Decoder is new GNAT.Decode_String
        (Encoding_Method => Opt.Wide_Character_Encoding_Method);
   ...
   is
      ...
      --  according to the encoding method. The encoding method is in
      --  Opt.Wide_Character_Encoding_Method, or is indicated by a BOM
   ...
   begin
      ...
      Insert_Ada_Source (Buf, Input (First .. Input'Last), Expand_Tabs);
