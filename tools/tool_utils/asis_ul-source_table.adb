...
package body ASIS_UL.Source_Table is
   ...
   begin
      ...
      if Verbose_Mode or else Debug_Mode or else Debug_Flag_S then
   ...
   begin
      ...
      loop
         ...
         begin
            ...
            String_Utilities.String_Vectors.Append (Files_From_File, Tmp_Str);

            if Store_With_No_Check then
               Store_Sources_To_Process (Tmp_Str);
            else
               Add_Source_To_Process (Tmp_Str, Arg_Project);
            end if;
         end;
   ...
   begin
      if Debug_Flag_S or else ASIS_UL.Options.Debug_Mode then
         Source_Table_Debug;
      end if;
