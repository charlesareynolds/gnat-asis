...
package ASIS_UL.Source_Table is
   ...
   Files_From_File : String_Utilities.String_Vector;
   --  File names that came from the "-file=..." command-line option, as read
   --  by Read_Args_From_File.
   ...
   --  OFF.
   --
   --  Par_File_Name is also appended to Files_From_File.
