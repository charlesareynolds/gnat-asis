...
package body GNATtest.Harness.Generator is
   ...
   begin
      ...
      S_Put (0, "all: $(patsubst %.gpr,%-build,$(PRJS))");
      Put_New_Line;
      Put_New_Line;

      S_Put (0, "clean: $(patsubst %.gpr,%-clean,$(PRJS))");
      Put_New_Line;
      ...
      Put_New_Line;
      S_Put (0, "pragma Check_Policy (Pre, Off);");
      Put_New_Line;
      S_Put (0, "pragma Check_Policy (Post, Off);");
      Put_New_Line;
   ...
   begin
      ...
      if RTS_Path.all /= "" then
         if RTS_Attribute_Val = null then
            S_Put (3, "for Runtime (""Ada"") use """ & RTS_Path.all & """;");
         else
            S_Put
              (3,
