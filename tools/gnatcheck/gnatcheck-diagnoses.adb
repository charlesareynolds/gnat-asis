...
package body Gnatcheck.Diagnoses is
   ...
   function Params_Img (Params : String_List_Access) return String;
   ...
   --  the format suitable for including in a diagnosis.
...
--         Print_Failure_Info;
   ...
   function Params_Img (Params : String_List_Access) return String is
      Res_Len : Natural := 0;
   begin
                     ...
                     if Next_Par_S_Info.Exempt_Info.Detected = 0 then
                        ...
                        Store_Diagnosis
                          (Text => Short_Source_Name (SF) & ':'              &
                                   ...
                                   & ": no detection for '"                  &
                                   Rule_Name (Rule) & ": "                   &
                                   Params_Img (Next_Par_S_Info.Params)       &
   ...
   begin
      ...
      loop
         ...
         if Allowed_As_Exemption_Parameter
              (Rule, To_Lower (Remove_Spaces (Pars (Par_Start .. Par_End))))
         then
